URL aplikacije: https://web2spaprojekt.onrender.com/

1. interpolation/one-way binding - da, one-way bindind: src/components/Converter.vue, :61; interpolation: src/components/Game.vue, :37
